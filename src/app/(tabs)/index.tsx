        ...
        {authLoading || band === undefined ? (
          ...
          <View style={styles.actions}>
            <View style={styles.bandBanner}>
              <ThemedText type="smallBold" themeColor="textSecondary">Aktive Band</ThemedText>
            ...
            <Pressable
              ...
              <ThemedView type="backgroundElement" style={styles.actionCardInner}>
                <View style={styles.actionIconRow}>
                  <SymbolView tintColor={theme.text} name={{ ios: 'calendar', web: 'calendar_today' }} size={24} />
                  <ThemedText type="smallBold">Termine</ThemedText>
                </View>
                <ThemedText type="small" themeColor="textSecondary">Nächste Proben & Auftritte</ThemedText>
              </ThemedView>
            </Pressable>
            ...
            <Pressable
              ...
              <ThemedView type="backgroundElement" style={styles.actionCardInner}>
                <View style={styles.actionIconRow}>
                  <SymbolView tintColor={theme.text} name={{ ios: 'plus.circle.fill', web: 'add_circle' }} size={24} />
                  <ThemedText type="smallBold">Neuer Termin</ThemedText>
                </View>
                <ThemedText type="small" themeColor="textSecondary">Probe oder Auftritt anlegen</ThemedText>
              </ThemedView>
            </Pressable>
            ...
            <Pressable
              ...
              <ThemedView type="backgroundElement" style={styles.actionCardInner}>
                <View style={styles.actionIconRow}>
                  <SymbolView tintColor={theme.text} name={{ ios: 'person.crop.circle', web: 'person' }} size={24} />
                  <ThemedText type="smallBold">Profil</ThemedText>
                </View>
                <ThemedText type="small" themeColor="textSecondary">Profil & Band-Einstellungen</ThemedText>
              </ThemedView>
            </Pressable>
          </View>
        ) : isAuthenticated ? (
          ...
          <View style={styles.onboarding}>
            <ThemedView type="backgroundElement" style={styles.onboardingCard}>
              <SymbolView tintColor={theme.text} name={{ ios: 'music.mic', web: 'mic' }} size={32} />
              ...
              <Pressable
                ...
                <SymbolView tintColor={theme.background} name={{ ios: 'plus', web: 'add' }} size={18} />
                <ThemedText type="smallBold" style={{ color: theme.background }}>Band erstellen</ThemedText>
              </Pressable>
          ...
          <View style={styles.actions}>
            <ThemedView type="backgroundElement" style={styles.welcomeCard}>
              <ThemedText type="smallBold" style={styles.centerText}>Willkommen!</ThemedText>
              <ThemedText type="small" themeColor="textSecondary" style={styles.centerText}>
              ...
              <Pressable
                ...
                <ThemedText type="smallBold" style={{ color: theme.background }}>Zum Login</ThemedText>
              </Pressable>
            </ThemedView>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  welcomeCard: { padding: Spacing.four, borderRadius: Spacing.four, gap: Spacing.three, alignItems: 'center' },
